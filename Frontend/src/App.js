...
import RT_Specs from "./components/RT_Specs";
...
function App() {
    ...
    const [specs_rt, setSpecs_rt] = useState({ram_rt: "iniziare il monitoraggio di ip o ram per visualizzare", cpu_rt: "iniziare il monitoraggio di ip o ram per visualizza"});
    ...
    return (
        <div className={isHighContrast ? 'AppContrastoElevato' : 'App'}>
            ...
            <div style={{height: "100%", display: "flex", flexDirection: "row", width: "100%", padding: "10px"}}>
                <div style={{width: "25%"}}>
                    <Ip_src_form socket={socketInstance} connection={connection} />
                </div>
                <div style={{width: "25%"}}>
                    <SO_resource_form socket={socketInstance} connection={connection} />
                </div>
                <div>
            ...
            <div class="rights" style={{borderBottom: "2px solid #4f8bf9"}}>
                <div>©2024 CMZ Sentinel. Tutti i diritti riservati </div>
            </div>
        </div>
    );
}
